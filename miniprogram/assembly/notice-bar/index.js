var _slicedToArray = function(A, e) {
    if (Array.isArray(A)) return A;
    if (Symbol.iterator in Object(A)) return function(A, e) {
        var t = [], r = !0, i = !1, n = void 0;
        try {
            for (var a, o = A[Symbol.iterator](); !(r = (a = o.next()).done) && (t.push(a.value), 
            !e || t.length !== e); r = !0) ;
        } catch (A) {
            i = !0, n = A;
        } finally {
...
Component({
    ...
    methods: {
        ...
        startAnimation: function() {
            ...
            var A = this.data, i = A.overflowWidth, n = A.loop, e = A.leading, a = A.trailing, o = A.speed, t = 0 === this.data.animatedWidth ? e : o;
            0 !== this.data.overflowWidth && (this.marqueeTimer = setTimeout(function A() {
                var e = r.data.animatedWidth + 1, t = i < e;
                if (t) {
                    if (!n) return !1;
                    e = 0;
                }
        ...
        initAnimation: function() {
            var i = this, A = wx.createSelectorQuery().in(this);
            A.select(".wux-notice-bar__marquee-container").boundingClientRect(), A.select(".wux-notice-bar__marquee").boundingClientRect(), 
            A.exec(function(A) {
                if (A.filter(function(A) {
                    return !A;
                }).length) return !1;
                var e = _slicedToArray(A, 2), t = e[0], r = e[1].width - t.width;
                r !== i.data.overflowWidth && i.setData({
                    overflowWidth: r
                }, i.startAnimation);
            });
        },
