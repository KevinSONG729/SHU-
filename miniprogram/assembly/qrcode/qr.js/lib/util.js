var Mode = require("./mode"), Polynomial = require("./Polynomial"), math = require("./math"), QRMaskPattern = {
    PATTERN000: 0,
    PATTERN001: 1,
    PATTERN010: 2,
    PATTERN011: 3,
    ...
    getLostPoint: function(r) {
        ...
        for (a = 0; a < t - 1; a++) for (i = 0; i < t - 1; i++) {
            var T = 0;
            r.isDark(a, i) && T++, r.isDark(a + 1, i) && T++, r.isDark(a, i + 1) && T++, r.isDark(a + 1, i + 1) && T++, 
            0 != T && 4 != T || (e += 3);
        }
